...
import { LayoutDashboard, FileText, BarChart2, Users, Receipt, RefreshCw, Settings } from 'lucide-react'
...
const features = [
  ...
  },
  {
    ...
    desc: 'Zadejte výdaje kategorie podle kategorie — software, hardware, cestovné, marketing. Mějte přehled o tom, co vás stojí podnikání.',
...
export function FeatureShowcase() {
  ...
  return (
    <div className="grid lg:grid-cols-[340px_1fr] gap-8 items-start">
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                {isActive && (
                  <p className="text-xs text-slate-400 mt-0.5 leading-relaxed line-clamp-2">{f.desc}</p>
                )}
              </div>
      ...
      {/* Screenshot panel */}
      <div className={cn(
        'relative rounded-2xl overflow-hidden border shadow-2xl transition-all',
        `ring-2 ${c.ring}`,
      )}>
        {/* Browser chrome */}
        ...
        <div className="relative aspect-[1200/740] w-full">
          <Image
            key={current.img}
            src={current.img}
            alt={current.title}
